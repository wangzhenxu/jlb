  ...
  <form action="/cmsSolution/sub/edit.action" method="post" id="editForm">
	  <input type="hidden" name="desc" id="desc" >
	  <input type="hidden" name="arch" id="arch" >
	  <input type="hidden" name="func" id="func" >
  <input type="hidden" name="csId" value="${po.csId!''}" >
 <div class="right">
    <div class="location">
     <div class="location01">您现在的位置是：首页 &gt; <a href="control.html">CMS发布管理</a> &gt; 修改系统 </div>
    </div>
    <div class="nav">
     <div class="basic">
       ...
       <table width="100%" border="0" align="left">
         ...
         <tr>
           ...
           <td align="left" valign="middle">
           		           		<input name="name" type="text" id="name"  class="input validate[required] text-input" value="${po.name!''}" />
           </td>
           <td>&nbsp;</td>
         </tr>
         <tr>
         ...
         <tr>
           ...
           <td align="left" valign="middle" class="hui">
           		<textarea  cols="45" rows="5" class="texta1 ckeditor" name="desc1"  id="desc1" >${po.desc!''}</textarea>
           </td>
           <td class="hui">&nbsp;</td>
           <td width="15">&nbsp;</td>
         </tr>
         ...
         <tr>
           <td align="right" valign="top" class="hui1"><span class="red">*</span> 模块内容：</td>
           <td align="left" valign="middle" class="hui">
           <textarea name="arch1" id="arch1" cols="45" rows="5" class="texta1 ckeditor" >${po.arch!''}</textarea>
           </td>
           <td class="hui">&nbsp;</td>
           <td>&nbsp;</td>
         </tr>
         ...
         <tr>
           <td align="right" valign="top" class="hui1"><span class="red">*</span> 模块内容：</td>
           <td align="left" valign="middle" class="hui">
           		<textarea name="func1" id="func1" cols="45" rows="5" class="texta1 ckeditor" >${po.func!''}</textarea></td>
           <td class="hui">&nbsp;</td>
           <td>&nbsp;</td>
         </tr>
          <tr>
           ...
           <td>&nbsp;</td>
				            ...
				            <div class="chanpin" >
				             	<ul>
			             	         <#list po.relationList as cat>
			  							<li tempName="${cat.paName!''}">${cat.paName!''} <a href="javascript:void(0)"><img onclick="removeLi(this)" src="/images/overlay-cancel.jpg" style="vertical-align:middle"/></a><input type="hidden" name="paId" value='${cat.paId!''}' ><input type="hidden" name="paName" value="${cat.paName!''}" > </li>
				         			 </#list>
				             	</ul>
				            </div>
			           </td>
			 ...
			 <tr>
	           ...
	           <td align="left" valign="middle" class="hui">
	           		<input  type="text" id="accessUrl" name="accessUrl" size="30" value="${po.accessUrl!''}" class="inputa" />
	           </td>
	           <td>&nbsp;</td>
         </tr>
         </table>
...
function add(){
		...
		//系统分类选择
	 	var cscId="${po.cscId!''}"; 
		$("select[name=cscId] option").each(function(){
			if(this.value==cscId){
			 	this.selected=true;
			}
		});
