     ...
     <div class="query1">
      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#dddddd" style=" border-collapse:collapse;">
       ...
       <tr>
         ...
         <td align="left" valign="middle">
         <#assign textvalue=""/>
         <#list product.tagList as tag>  
         <#assign textvalue=textvalue+tag.tagWord?trim/>
         <#if tag_has_next><#assign textvalue=textvalue+","/></#if>
         </#list>
         <textarea name="tag.tagWord" id="textarea" cols="45" rows="5" class="texta" validate="validate[required,length[1,20]]">${textvalue}</textarea><span class="lan1">例如：温度，湿度，红外监控等可以逗号、空格、回车的形式分隔开。</span></td>
         </tr>
       <tr>
