...
<body>
<div class="right">
<form id="attribute"  action="/product/management/AddAttribute.action" method="post">
    <div class="location">
     ...
     <input name="addType" id="addType" type="hidden"  class="input" value="0"/>
    </div>
    <div class="nav">
     <div class="basic">
       ...
       <div class="form2">
        <table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#ffffff" style="border-collapse:collapse" name="pro_attr">
		 ...
		 <tr class="hui1">
			 ...
			 <td align="center" bgcolor="#FFFFFF"><input type="radio" name="product.attributeList[#].isChief" id="radio5" value="1" checked="checked" /></td>
