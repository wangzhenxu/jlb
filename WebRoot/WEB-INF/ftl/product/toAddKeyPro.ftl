 ...
 <form id="product"  action="/product/management/addNKeyPro.action" method="post" enctype="multipart/form-data">
    ...
    <div class="nav">
     ...
     <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#dddddd" style=" border-collapse:collapse;">
       <tr>
        <td colspan="2" align="left" class="red">* 号为必填项 <input name="product.hasKey"  type="hidden" value="1"></td>
        </tr>
       <tr>
       ...
       <tr>
         ...
         <td align="left" valign="middle"><input type="radio" name="product.productType" id="radio" checked="true"  value="1"  style=" vertical-align:middle"/>
           <span class="hui"> 网关</span>&nbsp;&nbsp;
           <input type="radio" name="product.productType" id="radio"  value="2"  style=" vertical-align:middle"/>
           <span class="hui"> 中间件
             <input type="radio" name="product.productType" id="radio"  value="4"  style=" vertical-align:middle"/>
             读写器</span></td>
         </tr>
       <tr>
       ...
       <tr>
         ...
         <td align="left" valign="middle"><textarea name="tag.tagWord" id="textarea" cols="45" rows="5" class="texta" validate="validate[required,length[1,20]]"></textarea><span class="lan1">例如：温度，湿度，红外监控等可以逗号、空格、回车的形式分隔开。</span></td>
         </tr>
       <tr>
       ...
       <tr>
         ...
         <td align="left" class="hui">对于网关默认接入时公开数据 
           <input type="radio" name="product.isPublic" id="radio6" value="1"  style=" vertical-align:middle"/>
           公开&nbsp;&nbsp;
           <input name="product.isPublic" type="radio" id="radio7"  style=" vertical-align:middle" value="0" checked="checked"/>
           不公开</td>
       </tr>
       </table>
    </div>
    </div>
    <div class="anniu"><a href="javascript:void(0);" onclick="addproduct();"><img src="/images/erji1_19.jpg" width="101" height="29" /></a></div>
   </form>
   </div>
</body>
</html>
