...
function remove(t){
 ...
 $(t).parent().text("")
 $(".temp").append("<a href='javascript:void(0)' class='Attribute' onclick='add(this)'>"+"[点击从属性Key中选择]"+"</a>");
...
<body>
 ...
 <form id="Command"  action="/product/management/AddCommand.action" method="post" class="amend">
    ...
    <div class="nav">
     <div class="basic">
	 <div class="basic01">控制命令编辑</div>
	</div>
     <div class="jiben"><img src="/images/liucheng3.png" width="570" height="60" /></div> 
	 <div class="xuxian">
      <div class="nature">
       <div class="form2">
           ...
           <#list CommandGroups as CommandGroup>
            <table width="100%" border="0"  class="paixu1" id="order1">
              <tr>
                ...
                <#else>
                 <a href="javascript:void(0)" class="Attribute" onclick="add(this)">[点击从属性Key中选择]</a>
                </#if>
                </td>
    ...
    <div class="anniu"><a href="/product/management/toUpdateAttribute.action?productId=${productId}"><img src="/images/syb.jpg" width="102" height="30" /></a> &nbsp;<a href="javascript:addCommand(1)"><img src="/images/bcx.jpg" width="102" height="30"  class="sub"/></a> &nbsp;<a href="javascript:addCommand(0)"><img src="/images/bct.jpg" width="102" height="30"  class="sub"/></a></div>
     </form>
   </div>
...
<div style="display:none">
		   <table width="100%" border="0" class="orders">
						  <tr>
							...
							<td width="19%" align="left" bgcolor="#e5e5e5" class="connect"><a href="javascript:void(0)"  onclick='add(this)'>[点击从属性Key中选择]</a></td>
							<td width="11%" align="left" bgcolor="#e5e5e5"><a href="javascript:void(0)" class="addbtn2"><img src="/images/erji1_17.jpg" width="88" height="23" /></a></td>
              				<td width="11%" align="right" bgcolor="#e5e5e5"><a href="javascript:void(0)" class="delete"><img src="/images/3.jpg" width="120" height="28" /></a></td>
						  </tr>
