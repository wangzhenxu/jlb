 ...
 <form id="product"  action="/product/management/update.action" method="post" enctype="multipart/form-data">
    ...
    <div class="nav">
     ...
     <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#dddddd" style=" border-collapse:collapse;">
       <tr>
        <td colspan="2" align="left" class="red">* 号为必填项</td>
        </tr>
       <tr>
         <td width="15%" align="right" class="hui1"><span class="red">*</span> 产品ID：
         <input name="product.productId" type="hidden"  class="input" value="${product.productId}"/>
       ...
       <tr class="showType">
         <td align="right" valign="top" class="hui1"><span class="red">*</span> 产品类型：</td>
         <td align="left" valign="middle"><input type="radio" name="product.showType" id="radio"  value="1"  style=" vertical-align:middle"/>
       ...
       <tr>
         ...
         <td align="left" valign="middle"><textarea name="product.description" id="textarea" cols="45" rows="5" class="texta">${product.description!""}</textarea>
          </td>
         </tr>
       <tr>
         <td align="right" valign="top" class="hui1"><span class="red">*</span> 标签TAGS：</td>
         <td align="left" valign="middle"><textarea name="tag.tagWord" id="textarea" cols="45" rows="5" class="texta" validate="validate[required,length[1,20]]"><#list product.tagList as tag>${tag.tagWord?trim}<#if tag_has_next>,</#if></#list></textarea> <span class="lan1">例如：温度，湿度，红外监控等可以逗号、空格、回车的形式分隔开。</span></td>
         </tr>
       <tr>
       ...
       <tr>
         ...
         <td align="left" class="hui1">
           ...
           <div id="preview_wrapper"> 
	        	<div id="preview_fake"> 
	            	<img id="preview" src="${ApplicationConst.PRODUCT_PIC_URL}${product.picUrl!""}" width="150px" height="150px"  onload="onPreviewLoad(this)"/> 
	        	</div> 
    		</div> 
    ...
    <div class="anniu"><a href="javascript:void(0);" onclick="update();"><img src="/images/bcx.jpg" width="102" height="30" /></a></div>
   </form>
   </div>
</body>
</html>
