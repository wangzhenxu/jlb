...
<div class="right">
    ...
    <div class="nav">
     ...
     <div class="form">
     <form method="POST" name="addProject" id="addProject" action="/project/add.action">
       <table class="table_style02">
	    <tr>
	      ...
	      <td width="72%" class="hui">
	        <input name="name" id="name"  type="text"  class="inputa  validate[required]"/>
	       </td>
	     </tr>
	     <tr>
	    ...
	    <tr>
	      ...
	      <td valign="middle" class="hui">
	        <input name="leader" id="leader" type="text"  class="inputa  validate[required]"/>
	      </td>
	      </tr>
	    <tr>
	      <td align="right" valign="middle" class="hui1">项目描述：</td>
	      <td class="hui"><textarea name="projectDesc" id="textarea" cols="45" rows="5" class="texta"></textarea></td>
	      </tr>
	    </table>
    </div>
     <div class="anniu"><a href="javascript:sub();"><img src="/images/erji1_19.jpg" /></a>&nbsp;<a href="javascript:history.go(-1);"><img src="/images/back1.jpg" /></a></div>
     </form>
    </div>
</div>
