...
public class Const {
	 ...
	 * 用户密码加密密钥
	 */
	public static final String USER_PASSWORD_KEY = "loit";
	 ...
	 * 产品类型--网关
	 */
	public static final int PRODUCT_SCENE=1;
	/**
	 * 产品类型--节点
	 */
	public static final int PRODUCT_NODE=3;
	/**
	 * 普通项目代码--PTXM
	 */
	public static final String COMMON_PROJECT="PTXM";
	/**
	 * 餐饮项目代码--CYXM
	 */
	public static final String REST_PROJECT="CYXM";
